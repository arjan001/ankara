        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-background/60 text-sm mt-4 leading-relaxed max-w-xs">
              Premium authentic Ankara clothing. Handcrafted suits, dresses, kimonos, and more. Celebrate African style with quality fabrics delivered across East Africa.
            </p>
